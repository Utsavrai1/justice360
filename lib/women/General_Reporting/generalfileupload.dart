...
class GeneralFileUpload extends StatefulWidget {
  String? id;
  GeneralFileUpload({super.key, required this.id});

  @override
  _GeneralFileUploadState createState() => _GeneralFileUploadState(id);
}

class _GeneralFileUploadState extends State<GeneralFileUpload> {
  String? id;
  _GeneralFileUploadState(this.id);
